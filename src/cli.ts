...
// This MUST be at the very top of the entry point, before any imports that might load xterm
import "./terminal/xterm-polyfill.js";

import { program } from "commander";

// Import App module dynamically after polyfill is set up
const { runChipilot } = await import("./tui/App.js");
